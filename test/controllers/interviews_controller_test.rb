...
class InterviewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create interview" do
    assert_difference('Interview.count') do
      post interviews_url, params: { interview: { date: @interview.date, notes: @interview.notes, title: @interview.title } }
    end
  ...
  test "should update interview" do
    patch interview_url(@interview), params: { interview: { date: @interview.date, notes: @interview.notes, title: @interview.title } }
